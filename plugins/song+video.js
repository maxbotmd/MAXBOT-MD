...
let downloadUrl = down.dl_url (⬆️)

//send audio + document message
(⬇️) await conn.sendMessage(from,{document: {url:downloadUrl},mimetype:"audio/mpeg",fileName:data.title + ".mp3",caption:"*MADE BY AUSTIN MAX 💖*"},{quoted:mek})
